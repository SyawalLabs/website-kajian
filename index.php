                            ...
                            <div class="info-card">
                                ...
                                <div class="structure-list">
                                    ...
                                    <div class="structure-item">
                                        <i class="fas fa-user"></i>
                                        <div>
                                            <strong>Ustadzah Nanda Mutiara Najib Putri</strong>
                                    ...
                                    <div class="structure-item">
                                        <i class="fas fa-user"></i>
                                        <div>
                                            <strong>Ustadzah Suhartini</strong>
                                            <div class="role">Pembina Asrama</div>
                                        </div>
                                    </div>
                                    <div class="structure-item">
                                        <i class="fas fa-user"></i>
                                        <div>
                                            <strong>Ustadzah Fania Imran Sutarno</strong>
                                            <div class="role">Pembina Asrama</div>
                                        </div>
                                    </div>
                                    <div class="structure-item">
                        ...
                        ?>
                            <div class="kajian-card">
                                ...
                                <div class="kajian-content">
                                    ...
                                    <div class="kajian-meta">
                                        <i class="fas fa-user"></i> Ustadz Ahmad Umar Al-Jailani
                                    </div>
                                    <div class="kajian-meta">
            ...
            <footer class="footer">
                <div class="container">
                    ...
                    <div class="footer-bottom">
                        <p>&copy; 2026 MAKN ENDE. All rights reserved. Developed with  ZULFIADI NGGOLO SORO<i class="fas fa-star" style="color: #f0e511;"></i> for MAKN ENDE</p>
                    </div>
                </div>
            </footer>
